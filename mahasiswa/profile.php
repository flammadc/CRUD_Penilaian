        ...
        <div class="container">
            <form class="mt-5 shadow-sm py-4 px-3 mb-5 bg-light rounded" enctype="multipart/form-data" method="post">
                ...
                <div class="mb-3 row align-items-center">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nim" class="form-control" id="nim" readonly value="<?php echo $dataProfile[0]; ?>">
                    </div>
                </div>
                ...
                <div class="mb-3 row align-items-center">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="jk" class="form-control" id="jk" readonly value="<?php echo $dataProfile[2]; ?>">
                    </div>
                </div>
                <div class="mb-3 row align-items-center">
                    <label for="jurusan" class="col-sm-2 fw-semibold col-form-label">Jurusan</label>
                    <div class="col-sm-10">
                        <input type="text" name="jurusan" class="form-control" id="jurusan" readonly value="<?php echo $dataProfile[3]; ?>">
                    </div>
                </div>
...
<?php
    ...
    $updateMhs = "UPDATE mahasiswa SET nama='$nama', password='$password' WHERE nim='$nim'";
